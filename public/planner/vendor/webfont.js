...
! function() {
	...
	$.prototype.g = function(t) {
		...
		if (e) {
			...
			p(this.c, function(t, n, i) {
				...
				o ? t([]) : (a["__MonotypeConfiguration" + e] = function() {
					return i.a
				}, n())
			})).id = "__MonotypeAPIScript" + e
		} else t([])
	...
	Z.prototype.load = function(t) {
		...
		var n = this.f.id,
			i = this.c.m,
			e = this;
		n ? (i.__webfontfontdeckmodule || (i.__webfontfontdeckmodule = {}), i.__webfontfontdeckmodule__[n] = function(n, i) {
